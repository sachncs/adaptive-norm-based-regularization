...
def run_energy() -> None:
    ...
    print(f"{'Method':<20} {'MSE':<10} {'MAE':<10} {'R²':<10} {'RMSE':<10}")
    for method in METHODS:
        ...
        trainer = Trainer(net, losses.MSELoss(), reg, opt, batch_size=32, epochs=500)
        ...
        print(f"{method:<20} {mse:<10.3f} {mae:<10.3f} {r2:<10.3f}" f" {rmse:<10.3f}")
...
def run_leukemia() -> None:
    ...
    # Repeated 10×5-fold CV as in paper.
    n_repeats = 10
